...
def send_onboarding_email(to_email: str, full_name: str):
    ...
    <br>
    <a href="https://app.dunexmarkets.com" style="background-color: #D4AF37; color: #05050A; padding: 12px 24px; text-decoration: none; border-radius: 6px; font-weight: bold; display: inline-block;">Access Your Dashboard</a>
    <br><br>
